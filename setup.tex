...
\csusetup{
  ...
  info = {%
    ...
    %   可使用“\\”命令手动控制换行
    %
    title           = {中南大学 \LaTeX{} 论文模板},
    title*          = {A Sample Document for \LaTeX-based CSU Thesis Template},
    %
    % 关键词
    %
    keywords        = {中南大学, 知行合一, 经世致用},
    keywords*       = {CSU, bachelor thesis, XeTeX/LaTeX template},
    %
    % 姓名
    %
    author          = {某\quad{}某},
...
\renewcommand{\bibfont}{\zihao{5}\kaishu}
% 导入参考文献数据库
